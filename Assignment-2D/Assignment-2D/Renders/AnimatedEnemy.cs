...
namespace Assignment_2D
{
    class AnimatedEnemy : Enemy
    {
        ...
        public override void Draw(SpriteBatch batch)
        {
            ...
            //Interface.DrawRectangle(new Rectangle((int)this.pos.X, (int)this.pos.Y, this.Width, this.Height), Interface.DummyTexture, Color.Red, batch, false, 1);
